...
public:
  ...
  void release_reference(Cache_Item* it);
  ...
  xixi_reason add(Cache_Item* item, uint64_t&/*out*/ cache_id);
  xixi_reason set(Cache_Item* item, uint64_t&/*out*/ cache_id);
  xixi_reason replace(Cache_Item* item, uint64_t&/*out*/ cache_id);
  xixi_reason append(Cache_Item* item, uint64_t&/*out*/ cache_id);
  xixi_reason prepend(Cache_Item* item, uint64_t&/*out*/ cache_id);
